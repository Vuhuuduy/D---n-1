...
<head>
    ...
    <link rel="stylesheet" href="./view/assets/css/vendor/pe-icon-7-stroke.css">
    <!-- Font-awesome CSS -->
    <link rel="stylesheet" href="./view/assets/css/vendor/font-awesome.min.css">
    <!-- Slick slider css -->
    <link rel="stylesheet" href="./view/assets/css/plugins/slick.min.css">
    <!-- animate css -->
    <link rel="stylesheet" href="./view/assets/css/plugins/animate.css">
    <!-- Nice Select css -->
    <link rel="stylesheet" href="./view/assets/css/plugins/nice-select.css">
    <!-- jquery UI css -->
    <link rel="stylesheet" href="./view/assets/css/plugins/jqueryui.min.css">
    <!-- main style css -->
